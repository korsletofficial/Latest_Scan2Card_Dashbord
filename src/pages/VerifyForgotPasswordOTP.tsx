...
const VerifyForgotPasswordOTP = () => {
  ...
  const { userId, email, sentVia } = location.state || {};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await authAPI.verifyForgotPasswordOTP(userId, otpValue, 'forgot_password');
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                ...
                {sentVia && <span className="text-sm text-gray-500"> via {sentVia}</span>}
              </p>
            </div>
              ...
              <div className="text-center">
                {resendTimer > 0 ? (
                  <p className="text-sm text-gray-600">
                    Resend code in <span className="font-medium text-[#854AE6]">{resendTimer}s</span>
                  </p>
                ) : (
                  <Button
                    type="button"
